...
object ServerHeader {
  ...
  object DataType extends Enumeration {
    type DataType = Value
    val LongType: ServerHeader.DataType.Value = Value(1)
    val DoubleType: ServerHeader.DataType.Value = Value(2)
    val ByteArrayType: ServerHeader.DataType.Value = Value(3)
    val FixedLenByteArrayType: ServerHeader.DataType.Value = Value(4)
  }
}
